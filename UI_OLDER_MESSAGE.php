<html>
    <head>
    <meta charset = "utf-8"/>
    <link rel = "styleSheet" href="../CSS/style_older_new.css"><title>Older Messages</title></head>
    ...
    <body>
		...
		<br><button2><button type="button" name="logout" onclick="window.location.href='UI_LOGIN.php'">logout</button><button2></div></h1><br><br>
