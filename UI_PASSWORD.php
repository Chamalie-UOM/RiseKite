...
<body>
    <h1><div class = "myfirst"><font color = "darkolivegreen"><big>Sri Lanka Army</big><img src ="army-crest.svg" alt="army crest" align="middle"></font></div></h1>

<form action="UI_PASSWORD.php" method="post">
    <fieldset>
    <legend><h2><big>Change the password</big></h2></legend>
    <p>
